...
// 创建 audioListener
const audioListener1 = new THREE.AudioListener()
camera.add(audioListener1)
const audoLoader = new THREE.AudioLoader()
const sound1 = new THREE.PositionalAudio(audioListener1)
const audioListener2 = new THREE.AudioListener()
camera.add(audioListener1)
const sound2 = new THREE.PositionalAudio(audioListener2)
audoLoader.load("./audio/gnzw.mp3", buffer => {
  sound1.setBuffer(buffer)
  sound1.setRefDistance(1)
})
audoLoader.load("./audio/gyz.mp3", buffer => {
